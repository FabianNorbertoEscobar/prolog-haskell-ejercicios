...
hombre(gonzalo,alta,castaño,joven).
hombre(lucas,baja,castaño,joven).
...
busca(gonzalo,alta,castaña,joven).
...
busca(laura,alta,castaña,joven).
busca(martina,media,rubio,joven).
busca(tatiana,media,castaña,joven).
busca(jessica,alta,negro,adulta).
busca(eugenia,baja,castaña,joven).
